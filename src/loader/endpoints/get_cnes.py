...
@allow_local
def now(config):
    # datamunicipios = pd.read_csv("datamunicipios.csv")
    ...
    # TODO: rever colunas necessárias
    ...
    df_cnes["hospital_dia_tot_ago"] = (
        df_cnes["hospital_dia_tot_ago"].astype(str).astype(int)
    )
    df_cnes["UTI_adulto_I_tot_ago"] = (
        df_cnes["UTI_adulto_I_tot_ago"].astype(str).astype(int)
    )
    df_cnes["UTI_adulto_II_tot_ago"] = (
        df_cnes["UTI_adulto_II_tot_ago"].astype(str).astype(int)
    )
    df_cnes["UTI_adulto_III_tot_ago"] = (
        df_cnes["UTI_adulto_III_tot_ago"].astype(str).astype(int)
    )
    df_cnes["UTI_adulto_II_COVID_SUS_ago"] = (
        df_cnes["UTI_adulto_II_COVID_SUS_ago"].astype(str).astype(int)
    )
    df_cnes["UTI_adulto_II_COVID_nao_SUS_ago"] = (
        df_cnes["UTI_adulto_II_COVID_nao_SUS_ago"].astype(str).astype(int)
    )
    df_cnes["UTI_pediatrica_II_COVID_SUS_ago"] = (
        df_cnes["UTI_pediatrica_II_COVID_SUS_ago"].astype(str).astype(int)
    )
    df_cnes["UTI_pediatrica_II_COVID_nao_SUS_ago"] = (
        df_cnes["UTI_pediatrica_II_COVID_nao_SUS_ago"].astype(str).astype(int)
    )
    df_new["number_beds"] = (
